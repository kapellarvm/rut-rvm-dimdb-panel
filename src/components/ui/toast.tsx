...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-lg border border-[var(--border)] bg-transparent px-3 text-sm font-medium transition-colors hover:bg-[var(--secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--ring)] disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-[var(--muted)]/40 group-[.destructive]:hover:border-[var(--destructive)]/30 group-[.destructive]:hover:bg-[var(--destructive)] group-[.destructive]:hover:text-[var(--destructive-foreground)] group-[.destructive]:focus:ring-[var(--destructive)]",
      className
    )}
    {...props}
  />
